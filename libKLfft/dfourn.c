 ...
 * lengths of each dimension (number of complex values), which MUST all be
 ...
 * equivalent to storing the array by rows.  If isign is input as -1, data
 * is replaced by its inverse transform times the product of the lengths of
 * all dimensions.
 *
 * Needs:
 */
