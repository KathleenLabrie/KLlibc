/* Function: mul2Images */
/* Version: 1.0.1 
 * 	Multiply to images or sections.  A shift can be applied to the
 *	second image before computation.  Note that if the shift is
 ...
 *
 * Calling mul2Images
 *	status = mul2Images(ppix1, ppix2, presult, naxes, section, dx, dy);
 *
 * Needs :
 */
