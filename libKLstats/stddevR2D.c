 ...
 * Does not handle distribution around zero (i.e. with + and - values)
 *
 * Needs:
 *   %%%libKLutil%%%
 */
		 ...
		 RASTER *rscan, double **pmask)
{
 ...
 /* Going up */
   ...
   if ((rscan->rstr_oldline >= 0) && (rscan->rstr_oldline < naxes[1])) {
     for (kk=(long)(ii-halfbox[0]); kk<=(long)(ii+halfbox[0]); kk++) {
       if ((kk>=0) && (kk<naxes[0]) && (*(*(pmask+rscan->rstr_oldline)+kk) == 0)) {
   ...
   if ((rscan->rstr_newline >= 0) && (rscan->rstr_newline < naxes[1])) {
     for (kk=(long)(ii-halfbox[0]); kk<=(long)(ii+halfbox[0]); kk++) {
       if ((kk>=0) && (kk<naxes[0]) && (*(*(pmask+rscan->rstr_newline)+kk) == 0)) {
 ...
 /* Right or left */
   ...
   if ((rscan->rstr_oldcol >=0) && (rscan->rstr_oldcol < naxes[0])) {
     for (ll=(long)(jj-halfbox[1]); ll<=(long)(jj+halfbox[1]); ll++) {
       if ((ll>=0) && (ll<naxes[1]) && (*(*(pmask+ll)+rscan->rstr_oldcol) == 0)) {
   ...
   if ((rscan->rstr_newcol >= 0) && (rscan->rstr_newcol < naxes[0])) {
     for (ll=(long)(jj-halfbox[1]); ll<=(long)(jj+halfbox[1]); ll++) {
       if ((ll>=0) && (ll<naxes[1]) && (*(*(pmask+ll)+rscan->rstr_newcol) == 0)) {
